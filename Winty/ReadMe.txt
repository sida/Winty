========================================================================
    WIN32 アプリケーション : Winty プロジェクトの概要
========================================================================

AppWizard はユーザー用に Winty アプリケーションを作成しました。  
このファイルには Winty アプリケーションを構成している
各ファイルの概要が含まれています。
...
Winty.ico
    ...
    このアイコンはメイン リソース ファイル Winty.rc に含まれています。

small.ico
    これはアイコン ファイルです。アプリケーション アイコンの小さいバージョンを含みます (16x16)。
    このアイコンはメイン リソース ファイル Winty.rc 
    に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル Winty.pch、
